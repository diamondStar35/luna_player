...
internal enum ActionId
{
    ...
    SeekBackwardX4, SeekForwardX4, SeekBackwardX8, SeekForwardX8, SeekStart, SeekEnd, SeekStep1, SeekStep2,
    SeekStep3, SeekStep4, SeekStep5, SeekStep6, SeekStep7, SeekStep8, SeekStep9, SeekStep0, SeekStepCustom,
